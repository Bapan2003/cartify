          ...
          SizedBox(
            ...
            child: Consumer<CartProvider>(
              builder: (context, cartProvider, child) {
                final isAdded = cartProvider.isInCart(widget.product.id); // implement this in CartProvider
                  ...
                  onPressed: () {
                    if (!isAdded) {
                      ...
                      cartProvider.addToCart(
                        CartModel.fromMap(widget.product.toJson(), widget.product.id, qty: qty),
                      );
                      ...
                      cartProvider.removeFromCart(
                        CartModel.fromMap(widget.product.toJson(), widget.product.id, ),
                      );
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text("${widget.product.productName} removed from cart")),
                      );
                    }
                  },
