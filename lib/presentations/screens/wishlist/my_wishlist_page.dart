        ...
        child: ConstrainedBox(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 16.0).copyWith(top: 15),
                  child: Text('Saved Products',style: TextStyle(fontSize: 22,fontWeight: FontWeight.w500),),
                ),
                ListView.separated(
                  primary: false,
                                  ...
                                  Expanded(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        const SizedBox(height: 4),
                                        Text(
                                          product.isFreeShipping?'Free':'Paid',
                                          style: const TextStyle(
                                            ...
                                            Expanded(
                                              child: Consumer<CartProvider>(
                                                builder: (context, cartProvider, child) {
                                                  final isAdded = cartProvider.isInCart(productId); // implement this in CartProvider

                                                  return ElevatedButton.icon(
                                                    onPressed: () {
                                                      if (!isAdded) {
                                                        cartProvider.addToCart(
                                                          CartModel.fromMap(product.toJson(), productId,),
                                                        );
                                                    ...
                                                    icon: Icon(isAdded ? Icons.delete : Icons.shopping_cart_outlined,color: Colors.white,),
                                                    label: Text(isAdded ? "Remove from Cart" : "Add to Cart",style: TextStyle(color: Colors.white),),
                                                    style: ElevatedButton.styleFrom(
                                                      ...
                                                      backgroundColor:isAdded? Colors.amber.shade700:Colors.grey,
                                                    ),
                                                  );
                                                },
                                              ),
